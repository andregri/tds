...
\begin{document}
	...
	\begin{wrapfigure}{r}{0.5\linewidth}%
		\vspace{-40pt}
		\includegraphics[width=\linewidth]{amplificatore.png}
	\end{wrapfigure}
	...
	\begin{figure}[h!]
		...
		\begin{subfigure}{0.48\linewidth}
			\includegraphics[width=\linewidth]{rc_circuit.jpg}
			\caption{circuito RC}
			\label{circuit:rc}
		\end{subfigure}
		\begin{subfigure}{0.48\linewidth}
			\includegraphics[width=\linewidth]{rc_plot.png}
	...
	\begin{figure}[h!]
		...
		\begin{subfigure}[b]{0.4\linewidth}
			\includegraphics[width=\linewidth]{massa_molla.png}
